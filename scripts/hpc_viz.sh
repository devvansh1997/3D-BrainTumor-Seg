...
echo "Generating segmentation visualisations" >> slurm_logs/$SLURM_JOB_ID/slurm_${SLURM_JOB_ID}.out
...
python scripts/visualize_seg.py configs/dynunet_hpc.yaml --num 2
